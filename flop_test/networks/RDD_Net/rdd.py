...
class Net(nn.Module):
    def __init__(
        ...
        modules_body1.append(
            ConvBlock(base_filter, feat, 3, 1, 1, activation="prelu", norm=None)
        )
        ...
        modules_body3.append(
            ConvBlock(feat, base_filter, 3, 1, 1, activation="prelu", norm=None)
        )
        ...
        self.decouping3 = ConvBlock(
            feat + 3 + 2, 3, 3, 1, 1, activation="prelu", norm=None
        )
        self.feat4 = ConvBlock(
        ...
        self.outRain = ConvBlock(
            (nFrames - 1) * 3, num_channels, 3, 1, 1, activation=None, norm=None
        )
        self.outMotion = ConvBlock(
            (nFrames - 1) * 2, 2, 3, 1, 1, activation=None, norm=None
        )
